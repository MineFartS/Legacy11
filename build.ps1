...
Write-Host ''
Write-Host 'Windows 11 Legacy USB Creator'
Write-Host 'Create a Windows 11 Installer USB for legacy BIOS'
Write-Host '--------------------------------------------------'
...
# Copy Windows 11 'autounattend.xml'
Copy-Item `
    -Path $ISO':\autounattend.xml' `
    -Destination $USB':\autounattend.xml' `
    -Force -Verbose
